...
export class BookingService {
  ...
  addBooking(
    ...
    dateTo: Date
      ...
      // pipe(take(1)) to avoid an ongoing subscription, just to get a snapshot;
      return this.authService.userId.pipe(take(1), switchMap(userId => {
        ...
        return this.http.post<{name: string}>('https://ion-bnb.firebaseio.com/bookings.json',
          { ...newBooking, id: null } // overwriting the id with;
        );
  ...
  fetchBookings() {
    return this.authService.userId.pipe(
      ...
      switchMap(userId => {
        ...
        (`https://ion-bnb.firebaseio.com/bookings.json?orderBy="userId"&equalTo="${userId}"`,
        );
      }),
      map(bookingData => {
        const bookings = [];
